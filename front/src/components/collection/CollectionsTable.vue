...
const columns = [
  ...
  {name: 'when', align: 'left', field: 'when'},
  {name: 'controls', align: 'left'},
];
const rows = [
  {id: 1, name: 'Hajisy', when: 'Eté'},
  {id: 2, name: 'Kasimo', when: '0330209481'},
  {id: 3, name: 'Hajisy', when: '0340209761'},
  {id: 3, name: 'Nazumy', when: 'Hiver'},
  {id: 4, name: 'Hajisy', when: '0340209786'},
  {id: 5, name: 'Kasimo', when: '0330209487'},
  {id: 6, name: 'Hajisy', when: 'Automne'},
  {id: 7, name: 'Nazumy', when: '0320209780'}
]
