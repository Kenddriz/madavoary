...
const columns = [
  ...
  {name: 'surface', align: 'left', field: 'surface'},
  {name: 'controls', align: 'left'},
];
const rows = [
  {id: 1, name: 'Hajisy', surface: '0340209781'},
  {id: 2, name: 'Kasimo', surface: '0330209481'},
  {id: 3, name: 'Hajisy', surface: '0340209761'},
  {id: 3, name: 'Nazumy', surface: '0320209789'},
  {id: 4, name: 'Hajisy', surface: '0340209786'},
  {id: 5, name: 'Kasimo', surface: '0330209487'},
  {id: 6, name: 'Hajisy', surface: '0340209768'},
  {id: 7, name: 'Nazumy', surface: '0320209780'}
]
