...
const menuBar = [
  {label: 'Accueil', to: '', icon: 'home', children: []},
  {label: 'Parcs', to: 'parcs', icon: 'parks', children: []},
  {label: 'Etres vivants', to: 'actualite', icon: 'far fa-newspaper', children: []},
  {label: 'Aventures', to: 'collections', icon: 'collections', children: []},
